	...
	<div class="container">
		<div class="w3-agileits-about-grids">
			<div class="col-md-6 agile-about-left">
				<h2 class="agileits-title">Selamat Datang di Situs Ranking Karyawan</h2>
				<h5>Situs Ranking Karyawan Unggulan di Kota Makassar</h5>
				<p>Ranking Karyawan Unggulan adalah sebuah website yang menampilkan ranking serta perbandingan karyawan (SMA Sederajat) di Kota Makassar. <span>Website ini diharapkan dapat membantu kalangan masyarakat untuk melihat perbandingan karyawan unggulan di kota Makassar agar  para orangtua dan calon siswa dapat melihat karyawan karyawan unggulan yang ada di kota Makassar</span> Dengan adanya situs ini juga bisa menjadi acuan bagi karyawan yang ada di Makassar untuk berlomba dalam memperbaiki Mutu Pendidikan yang ada di Kota Makassar.</p>
			</div>
	...
	<div class="container">
		<!--screen-gallery-->
			<div class="col-md-5 col-sm-12 wthree-testimonials-left">
				...
				<p>Lihat apa yang mereka katakan tentang Web Ranking Karyawan Unggulan</p>
			</div>
							      ...
							      <div class="item-owl">
					                	<div class="customer-say">
											  <div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<p> Web Ranking Karyawan Unggulan ini membantu saya untuk membandingkan karyawan karyawan unggulan apa saja yang terbaik di makassar.</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/front/p1.jpg" alt="">
															<a href="#">Sidin</a><p>, Orangtua</p>
														</div>		
													</div>
													<div class="clearfix"></div>     
												</div>
											...
											<div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														<h5 class="w3l">"Mengacu karyawan untuk berbenah"</h5>
														<p> Dengan adanya situs ini, karyawan karyawan khususnya tingkat SMA di kota Makassar saling berpacu untuk memperbaiki kualitas karyawan.</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/front/p2.jpg" alt="">
															<a href="#">Risal Rasak </a><p>, Guru</p>
														</div>		
													</div>
													<div class="clearfix"></div>     
												</div>
											  ...
											  <div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<p> Semoga terus dikembangkan agar tiap karyawan saling memperbaiki kualitasnya</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/front/p3.jpg" alt="">
															<a href="#">Lutfi</a><p>, Pelajar</p>
														</div>	
													</div>
													<div class="clearfix"></div>     
												</div>
											...
											<div class="col-md-6 col-sm-6 col-xs-6 customer-grid">
												<div class="de_testi">
													<div class="de_testi_by">
														...
														<p> Webnya keren. Semoga daftar karyawannya bisa ditambahkan lagi yaa</p>
														<div class="quotes">
															<img src="<?php echo base_url() ?>frontend/web/images/front/p4.jpg" alt="">
															<a href="#">Riski</a><p>, Mahasiswa</p>
														</div>	
													</div>
													<div class="clearfix"></div>     
												</div>
