<div class="jarallax w3ls-services agile-section" id="services">
	<div class="container">
		<h3 class="hdg agileits-title" style="color: orange; text-align: center;" id="h3.-bootstrap-heading">Status Ranking Karyawan Unggulan</h3>
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					foreach ($data as $d) {
					 ...
					 <tr>
					 	<td><?php echo $no++ ?></td>
					 	<td><?php echo $d->nama_karyawan ?> <?php echo anchor('Frontend/detail?karyawan='.$d->id_karyawan, '<span>Detail</span>', array('class'=>'label label-success')); ?></td>
