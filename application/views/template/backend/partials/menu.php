...
<?php $pages= $this->uri->segment(3); ?>
	...
	<p style="margin-top: 60px">
		<!-- <header class="logo-env"> -->
			...
			<!-- <div class="logo">
				<a href="index.html">
					<img src="<?= base_url() ?>assets/images/.png" width="120" alt="" />
				</a>
			</div> -->
		...
		<ul id="main-menu"class="">
			...
			<li><a href=" <?php echo base_url() ?> " target="_blank"><i class=""></i><span><font size="4">Halaman Depan</span></a></li>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
		            ...
		            <i class="glyphicon glyphicon-ok"></i> Najib Kurnia<br>
		            <i class="glyphicon glyphicon-ok"></i> NIM : 21.22.2474<br>
		            <i class="glyphicon glyphicon-ok"></i> Skripsi<br>
		            <!-- <i class="glyphicon glyphicon-ok"></i> <br><br> -->
				</div>
